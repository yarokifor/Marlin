...
//#define PSU_NAME "Power Supply"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    //#define AUTO_POWER_CHAMBER_TEMP  31 // (°C) Turn on PSU over this temperature
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    1.2  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.8  // (mm) Default layer height for the G26 Mesh Validation Tool.
